function varargout = gui_william2(varargin)
% gui_william2 M-file for gui_william2.fig
%      gui_william2, by itself, creates a new gui_william2 or raises the existing
%      singleton*.
%
%      H = gui_william2 returns the handle to a new gui_william2 or the handle to
%      the existing singleton*.
%
%      gui_william2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in gui_william2.M with the given input arguments.
%
%      gui_william2('Property','Value',...) creates a new gui_william2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_william2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_william2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_william2
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @gui_william2_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_william2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_william2 is made visible.
function gui_william2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_william2 (see VARARGIN)

% Choose default command line output for gui_william2
...
% UIWAIT makes gui_william2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = gui_william2_OutputFcn(hObject, eventdata, handles) 
...
while ishandle(handles.axes1)
    ...
    if get(handles.monitor_simulation,'UserData')
        draw_at_time_william(handles.scene,display_time);
    end
    drawnow;
end
%END USER CODE
...
set(handles.step_size,'String',num2str(S.time_step));
...
time_step = str2double(get(handles.step_size,'String'));
...
handles.scene = world1(L,H,W,number_of_edges,handles.axes1,max_time,time_step);
...
handles.scene.initialize_configuration(number_of_disks,R,number_of_boxes,l,w,h)
